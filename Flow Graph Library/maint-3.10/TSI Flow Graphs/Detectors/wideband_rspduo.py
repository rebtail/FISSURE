...
class wideband_rspduo(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "Wideband Rspduo", catch_exceptions=True)
...
def main(top_block_cls=wideband_rspduo, options=None):
    tb = top_block_cls()
